...
| Role | Model |
|---|---|
| Small / draft | `mlx-community/Qwen3-0.6B-4bit` |
| Big / target | `mlx-community/Qwen3.5-4B-OptiQ-4bit` |
...
```text
Loaded small MLX model: mlx-community/Qwen3-0.6B-4bit
Loaded big MLX model: mlx-community/Qwen3.5-4B-OptiQ-4bit
